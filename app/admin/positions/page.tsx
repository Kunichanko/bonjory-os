...
export default function AdminPositionsPage() {
  ...
  async function addPosition() {
    ...
    const emptyPerms: Record<PermissionKey, boolean> = {
      ...
      timeline_management: false, dm_management: false, announcement_management: false, assignment_management: false, gimmick_management: false, news_management: false,
    }
